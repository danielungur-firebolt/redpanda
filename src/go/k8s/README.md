...
[Official Redpanda Kubernetes operator](https://github.com/danielungur-firebolt/redpanda/src/go/k8s)
...
[Redpanda](https://github.com/danielungur-firebolt/redpanda) is a streaming platform for mission critical
...
```
kubectl apply -k https://github.com/danielungur-firebolt/redpanda/src/go/k8s/config/without-webhook
```
...
```
kubectl delete -k https://github.com/danielungur-firebolt/redpanda/src/go/k8s/config/default
```
